...
pub const nx_net_mode_t__NX_NET_AUTO: nx_net_mode_t_ = 0;
pub const nx_net_mode_t__NX_NET_DHCP: nx_net_mode_t_ = 1;
pub const nx_net_mode_t__NX_NET_STATIC: nx_net_mode_t_ = 2;
pub type nx_net_mode_t_ = libc::c_int;
pub use self::nx_net_mode_t_ as nx_net_mode_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct nx_net_parameters_t_ {
    pub ipv4_mode: nx_net_mode_t,
    pub ipv6_mode: nx_net_mode_t,
    pub ipv4_ip: u32,
...
#[test]
fn bindgen_test_layout_nx_net_parameters_t_() {
    const UNINIT: ::core::mem::MaybeUninit<nx_net_parameters_t_> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<nx_net_parameters_t_>(),
        28usize,
        concat!("Size of: ", stringify!(nx_net_parameters_t_))
    );
    assert_eq!(
        ::core::mem::align_of::<nx_net_parameters_t_>(),
        4usize,
        concat!("Alignment of ", stringify!(nx_net_parameters_t_))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_mode) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
            "::",
            stringify!(ipv4_mode)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv6_mode) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_ip) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_gateway) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
            "::",
            stringify!(ipv4_gateway)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_netmask) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
            "::",
            stringify!(ipv4_netmask)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_dns1) as usize - ptr as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ipv4_dns2) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nx_net_parameters_t_),
...
extern "C" {
    pub fn nxNetShutdown() -> libc::c_int;
}
