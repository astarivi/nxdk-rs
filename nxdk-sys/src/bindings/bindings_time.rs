...
pub type time_t = _PDCLIB_time_t;
pub type clock_t = _PDCLIB_clock_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct timespec {
    pub tv_sec: time_t,
...
extern "C" {
    pub fn asctime(timeptr: *const tm) -> *mut libc::c_char;
}
extern "C" {
    pub fn ctime(timer: *const time_t) -> *mut libc::c_char;
}
extern "C" {
