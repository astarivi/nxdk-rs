...
pub const CONFIG_HID_MAX_DEV: u32 = 8;
pub const CONFIG_HID_DEV_MAX_PIPE: u32 = 4;
pub const USB_DT_HID: u32 = 33;
pub const USB_DT_REPORT: u32 = 34;
pub const HID_REPORT_GET: u32 = 1;
pub const HID_GET_IDLE: u32 = 2;
pub const HID_GET_PROTOCOL: u32 = 3;
pub const HID_REPORT_SET: u32 = 9;
pub const HID_SET_IDLE: u32 = 10;
pub const HID_SET_PROTOCOL: u32 = 11;
pub const RT_INPUT: u32 = 1;
pub const RT_OUTPUT: u32 = 2;
pub const RT_FEATURE: u32 = 3;
#[repr(C)]
...
#[doc = " HID device structure \\hideinitializer"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct usbhid_dev {
    #[doc = "< USB device vendor ID. (from device descriptor)"]
    pub idVendor: u16,
    #[doc = "< USB device product ID. (from device descriptor)"]
    pub idProduct: u16,
    #[doc = "< Interface subclass code"]
    pub bSubClassCode: u8,
    #[doc = "< Interface protocol code"]
    pub bProtocolCode: u8,
    #[doc = "< Interrupt-in callback function"]
    pub read_func: HID_IR_FUNC,
    #[doc = "< Interrupt-out callback function"]
    pub write_func: HID_IW_FUNC,
    #[doc = "< UTR list of all INT in and out pipes in running"]
    pub utr_list: [*mut UTR_T; 4usize],
    #[doc = "< UTR list of INT out endpoints"]
    pub out_utr_list: *mut UTR_T,
    #[doc = "< This HID interface"]
    pub iface: *mut libc::c_void,
    #[doc = "< The unique ID to identify a HID device."]
    pub uid: u32,
    #[doc = "< Point to the next HID device"]
    pub next: *mut usbhid_dev,
    #[doc = "< Pointer to an optional user struct"]
    pub user_data: *mut libc::c_void,
}
#[test]
fn bindgen_test_layout_usbhid_dev() {
    const UNINIT: ::core::mem::MaybeUninit<usbhid_dev> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<usbhid_dev>(),
        52usize,
        concat!("Size of: ", stringify!(usbhid_dev))
    );
    assert_eq!(
        ::core::mem::align_of::<usbhid_dev>(),
        4usize,
        concat!("Alignment of ", stringify!(usbhid_dev))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).idVendor) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).bSubClassCode) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(usbhid_dev),
            "::",
            stringify!(bSubClassCode)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).bProtocolCode) as usize - ptr as usize },
        5usize,
        concat!(
            "Offset of field: ",
            stringify!(usbhid_dev),
            "::",
            stringify!(bProtocolCode)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).read_func) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(usbhid_dev),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).write_func) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(usbhid_dev),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).out_utr_list) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(usbhid_dev),
            "::",
            stringify!(out_utr_list)
        )
    );
    assert_eq!(
