...
pub const NXDK_NETWORK_CONFIG_MANUAL_IP: u32 = 4;
pub const NXDK_NETWORK_CONFIG_MANUAL_DNS: u32 = 8;
#[repr(C)]
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct nxdk_network_config_sector_t {
    pub unknown1: [u8; 40usize],
    pub hmac: [u8; 20usize],
    pub headerV2: u32,
    pub dhcpFlags: u32,
    pub unknown2: u32,
    pub manual: nxdk_network_config_sector_t__bindgen_ty_1,
    pub unknown3: [u8; 260usize],
    pub automatic: nxdk_network_config_sector_t__bindgen_ty_2,
    pub unknown4: [u8; 116usize],
    pub footer: u32,
}
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct nxdk_network_config_sector_t__bindgen_ty_1 {
    pub ip: u32,
    pub subnetMask: u32,
    pub defaultGateway: u32,
    pub primaryDns: u32,
    pub secondaryDns: u32,
}
#[test]
fn bindgen_test_layout_nxdk_network_config_sector_t__bindgen_ty_1() {
    const UNINIT: ::core::mem::MaybeUninit<nxdk_network_config_sector_t__bindgen_ty_1> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<nxdk_network_config_sector_t__bindgen_ty_1>(),
        20usize,
        concat!(
            "Size of: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1)
        )
    );
    assert_eq!(
        ::core::mem::align_of::<nxdk_network_config_sector_t__bindgen_ty_1>(),
        1usize,
        concat!(
            "Alignment of ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1)
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).subnetMask) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).defaultGateway) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1),
            "::",
            stringify!(defaultGateway)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).primaryDns) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).secondaryDns) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_1),
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct nxdk_network_config_sector_t__bindgen_ty_2 {
    pub ip: u32,
    pub subnetMask: u32,
    pub defaultGateway: u32,
    pub primaryDns: u32,
...
#[test]
fn bindgen_test_layout_nxdk_network_config_sector_t__bindgen_ty_2() {
    const UNINIT: ::core::mem::MaybeUninit<nxdk_network_config_sector_t__bindgen_ty_2> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<nxdk_network_config_sector_t__bindgen_ty_2>(),
        20usize,
        concat!(
            "Size of: ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_2)
        )
    );
    assert_eq!(
        ::core::mem::align_of::<nxdk_network_config_sector_t__bindgen_ty_2>(),
        1usize,
        concat!(
            "Alignment of ",
            stringify!(nxdk_network_config_sector_t__bindgen_ty_2)
...
#[test]
fn bindgen_test_layout_nxdk_network_config_sector_t() {
    const UNINIT: ::core::mem::MaybeUninit<nxdk_network_config_sector_t> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<nxdk_network_config_sector_t>(),
        492usize,
        concat!("Size of: ", stringify!(nxdk_network_config_sector_t))
    );
    assert_eq!(
        ::core::mem::align_of::<nxdk_network_config_sector_t>(),
        1usize,
        concat!("Alignment of ", stringify!(nxdk_network_config_sector_t))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).unknown1) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
            "::",
            stringify!(unknown1)
        )
    );
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).headerV2) as usize - ptr as usize },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).dhcpFlags) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).unknown2) as usize - ptr as usize },
        68usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).manual) as usize - ptr as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).unknown3) as usize - ptr as usize },
        92usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).automatic) as usize - ptr as usize },
        352usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).unknown4) as usize - ptr as usize },
        372usize,
        concat!(
            "Offset of field: ",
            stringify!(nxdk_network_config_sector_t),
...
extern "C" {
    pub fn nxLoadNetworkConfig(config: *mut nxdk_network_config_sector_t) -> bool;
}
extern "C" {
    pub fn nxSaveNetworkConfig(config: *const nxdk_network_config_sector_t) -> bool;
}
