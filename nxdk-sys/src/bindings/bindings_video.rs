...
pub const VIDEO_ENC_GET_SETTINGS: u32 = 6;
pub const VIDEO_ENC_VIDEOENABLE: u32 = 9;
pub const VIDEO_ENC_FLICKERFILTER: u32 = 11;
pub const VIDEO_ENC_SOFTEN_FILTER: u32 = 14;
pub const VIDEO_MODE_720P: u32 = 131072;
pub const VIDEO_MODE_1080I: u32 = 262144;
pub const VIDEO_MODE_480P: u32 = 524288;
pub const VIDEO_60Hz: u32 = 4194304;
pub const VIDEO_50Hz: u32 = 8388608;
pub const VIDEO_WIDESCREEN: u32 = 65536;
pub const VIDEO_LETTERBOX: u32 = 1048576;
pub const VIDEO_ADAPTER_MASK: u32 = 255;
pub const VIDEO_STANDARD_MASK: u32 = 65280;
pub const REFRESH_50HZ: u32 = 50;
pub const REFRESH_60HZ: u32 = 60;
pub const REFRESH_DEFAULT: u32 = 0;
...
#[test]
fn bindgen_test_layout__VIDEO_MODE() {
    const UNINIT: ::core::mem::MaybeUninit<_VIDEO_MODE> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<_VIDEO_MODE>(),
        16usize,
        concat!("Size of: ", stringify!(_VIDEO_MODE))
    );
    assert_eq!(
        ::core::mem::align_of::<_VIDEO_MODE>(),
        4usize,
        concat!("Alignment of ", stringify!(_VIDEO_MODE))
    );
    assert_eq!(
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _GAMMA_RAMP_ENTRY {
    pub red: libc::c_uchar,
    pub green: libc::c_uchar,
    pub blue: libc::c_uchar,
}
#[test]
fn bindgen_test_layout__GAMMA_RAMP_ENTRY() {
    const UNINIT: ::core::mem::MaybeUninit<_GAMMA_RAMP_ENTRY> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<_GAMMA_RAMP_ENTRY>(),
        3usize,
        concat!("Size of: ", stringify!(_GAMMA_RAMP_ENTRY))
    );
    assert_eq!(
        ::core::mem::align_of::<_GAMMA_RAMP_ENTRY>(),
        1usize,
        concat!("Alignment of ", stringify!(_GAMMA_RAMP_ENTRY))
    );
    assert_eq!(
...
pub type GAMMA_RAMP_ENTRY = _GAMMA_RAMP_ENTRY;
extern "C" {
    pub fn XVideoGetEncoderSettings() -> DWORD;
}
extern "C" {
    pub fn XVideoGetFB() -> *mut libc::c_uchar;
}
extern "C" {
    pub fn XVideoSetFB(fb: *mut libc::c_uchar);
}
extern "C" {
    pub fn XVideoGetMode() -> VIDEO_MODE;
}
extern "C" {
    pub fn XVideoFlushFB();
}
extern "C" {
    pub fn XVideoSetFlickerFilter(level: libc::c_int);
}
extern "C" {
    pub fn XVideoSetMode(
        width: libc::c_int,
        height: libc::c_int,
        bpp: libc::c_int,
        refresh: libc::c_int,
...
extern "C" {
    pub fn XVideoSetSoftenFilter(enable: BOOL);
}
extern "C" {
    pub fn XVideoSetVideoEnable(enable: BOOL);
}
extern "C" {
    pub fn XVideoSetGammaRamp(
        offset: libc::c_uint,
        entries: *const GAMMA_RAMP_ENTRY,
        count: libc::c_uint,
    );
}
extern "C" {
    pub fn XVideoListModes(
        vm: *mut VIDEO_MODE,
        bpp: libc::c_int,
        refresh: libc::c_int,
...
extern "C" {
    pub fn XVideoWaitForVBlank();
}
extern "C" {
    pub fn XVideoGetVideoBase() -> *mut libc::c_uchar;
}
extern "C" {
    pub fn XVideoVideoMemorySize() -> libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
