...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct _FATX_SUPERBLOCK {
    pub Signature: u32,
    pub VolumeId: u32,
    pub SectorsPerCluster: u32,
    pub FirstClusterOffset: u32,
    pub Unknown: u16,
}
#[test]
fn bindgen_test_layout__FATX_SUPERBLOCK() {
    const UNINIT: ::core::mem::MaybeUninit<_FATX_SUPERBLOCK> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<_FATX_SUPERBLOCK>(),
        18usize,
        concat!("Size of: ", stringify!(_FATX_SUPERBLOCK))
    );
    assert_eq!(
        ::core::mem::align_of::<_FATX_SUPERBLOCK>(),
        1usize,
        concat!("Alignment of ", stringify!(_FATX_SUPERBLOCK))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(_FATX_SUPERBLOCK),
            "::",
            stringify!(Signature)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).VolumeId) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(_FATX_SUPERBLOCK),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).SectorsPerCluster) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_FATX_SUPERBLOCK),
            "::",
            stringify!(SectorsPerCluster)
        )
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).FirstClusterOffset) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(_FATX_SUPERBLOCK),
            "::",
            stringify!(FirstClusterOffset)
        )
    );
    assert_eq!(
...
pub type FATX_SUPERBLOCK = _FATX_SUPERBLOCK;
